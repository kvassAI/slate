...
**account_number** | `string` | Account number of the invoice issuer that will recieve the payment
...
**currency** | `string` | ISO code of currency: "EUR", "USD", "NOK" etc. _Required field_
